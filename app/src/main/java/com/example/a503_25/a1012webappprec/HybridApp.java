...
public class HybridApp extends AppCompatActivity {
    ...
    class WebCusotomClient extends WebViewClient {
        @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //자바스크립트에서 네이티브 메소드를 호출 할 수 있도록 설정
        //첫번째 매개변수는 메소드의 위치를 알려주는 것이고
        //두번째 매개변수는 html에서 호출할 때 사용할 인스턴스 이름 MYAPP. 해서 호출
        webView.addJavascriptInterface(new AndroidJavascriptInterface(this),"MYAPP");



        //url 로딩
        webView.loadUrl("http://192.168.0.235:8080/mobileweb/hybridapp");
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //자바스크립트 함수 호출
                webView.loadUrl("javascript:showDisplayMessage('"+editText.getText().toString()+"')");
            }
        });
